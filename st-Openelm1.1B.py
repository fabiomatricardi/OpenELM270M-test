...
if "hf_model" not in st.session_state:
    st.session_state.hf_model = "OpenELM_1.1B"
...
def writehistory(text):
    with open('chathistoryOpenELM1.1B.txt', 'a', encoding='utf-8') as f:
        f.write(text)
        f.write('\n')
    f.close()
...
### START STREAMLIT UI
st.image('LogoOpenELM1.1b-instruct.png', )
