...
if "hf_model" not in st.session_state:
    st.session_state.hf_model = "OpenELM_450M"
...
def writehistory(text):
    with open('chathistoryOpenELM450M.txt', 'a', encoding='utf-8') as f:
        f.write(text)
        f.write('\n')
    f.close()
...
### START STREAMLIT UI
st.image('LogoOpenELM450-instruct.png', )
